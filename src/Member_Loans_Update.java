...
public class Member_Loans_Update extends javax.swing.JFrame {
    Connection con;
    ...
    private void initComponents() {
        ...
        jPanel8.add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 40, 100, 40));
        ...
        jPanel8.add(txtPeriod, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 350, 210, 40));

        txtLid.setFont(new java.awt.Font("Rockwell", 1, 18)); // NOI18N
        txtLid.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(26, 69, 124)));
        txtLid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtLidActionPerformed(evt);
            }
        });
        jPanel8.add(txtLid, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 40, 180, 40));
        ...
        jPanel8.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 470, 150, 40));
        ...
        jPanel8.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 400, -1, -1));
        ...
        jPanel8.add(txtInterest, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 400, 210, 40));
...
try {
             ...
             rs = pst1.executeQuery("select * from loans where Lid='"+LID+"'and user='"+Login.usern+"'");
             if(rs.next())
             {
...
JOptionPane.showMessageDialog(this,"Updated Successfully");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Member_Loans_Update.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }


        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Member_Loans_Update().setVisible(true);
            }
        });
    }
