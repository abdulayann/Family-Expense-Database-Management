...
public class Member_Expenses_Insert extends javax.swing.JFrame {
    Connection con;
    PreparedStatement pst;
    public Member_Expenses_Insert() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel8.add(txtMode, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 280, 210, 40));
        ...
        jPanel8.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 280, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Member_Expenses_Insert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Member_Expenses_Insert().setVisible(true);
