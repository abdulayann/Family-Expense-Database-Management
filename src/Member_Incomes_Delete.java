...
public class Member_Incomes_Delete extends javax.swing.JFrame {
    Connection con;
    PreparedStatement pst1;
    
    public Member_Incomes_Delete() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText(" IID:");
        jPanel3.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 110, 90, 60));

        txtIid.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        txtIid.setToolTipText("");
        txtIid.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(42, 68, 148), 2, true));
        txtIid.setMargin(new java.awt.Insets(2, 10, 2, 6));
        txtIid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtIidActionPerformed(evt);
            }
        });
        jPanel3.add(txtIid, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 120, 220, 50));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            ...
            pst1 = con.prepareStatement("delete from incomes where  iid=? and user=? ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Member_Incomes_Delete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Member_Incomes_Delete().setVisible(true);
            }
        });
    }
