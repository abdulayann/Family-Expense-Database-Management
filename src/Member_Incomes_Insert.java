...
public class Member_Incomes_Insert extends javax.swing.JFrame {
    Connection con;
    PreparedStatement pst;
    public Member_Incomes_Insert() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Member_Incomes_Insert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Member_Incomes_Insert().setVisible(true);
