...
public class Member_Incomes_Update extends javax.swing.JFrame {
    Connection con;
    PreparedStatement pst;
    Statement pst1;
    ResultSet rs;

    public Member_Incomes_Update() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtIid.setFont(new java.awt.Font("Rockwell", 1, 18)); // NOI18N
        txtIid.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(26, 69, 124)));
        txtIid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtIidActionPerformed(evt);
            }
        });
        jPanel8.add(txtIid, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 40, 180, 40));
    ...
    private void FetchButActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FetchButActionPerformed
             ...
             int IID = Integer.parseInt(txtIid.getText());
             
             pst1 = con.createStatement();
             rs = pst1.executeQuery("select * from incomes where iid='"+IID+"'and user='"+Login.usern+"'");
             if(rs.next())
             {
...
JOptionPane.showMessageDialog(this,"Updated Successfully");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Member_Incomes_Update.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Member_Incomes_Update().setVisible(true);
            }
        });
    }
