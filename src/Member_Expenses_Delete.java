...
public class Member_Expenses_Delete extends javax.swing.JFrame {
    Connection con;
    PreparedStatement pst1;
    
    public Member_Expenses_Delete() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtEid.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        txtEid.setToolTipText("");
        txtEid.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(42, 68, 148), 2, true));
        txtEid.setMargin(new java.awt.Insets(2, 10, 2, 6));
        txtEid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtEidActionPerformed(evt);
            }
        });
        jPanel3.add(txtEid, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 110, 220, 50));
        ...
        jLabel2.setText("DELETE EXPENSE :");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            ...
            pst1 = con.prepareStatement("delete from expenses where  eid=? and user=? ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Member_Expenses_Delete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Member_Expenses_Delete().setVisible(true);
            }
        });
    }
